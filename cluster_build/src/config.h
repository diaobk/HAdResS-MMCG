...
#define VERSION  "4.6-dev"

/* Use the version string from generated version.h */
#define USE_VERSION_H

/* Default location of data files */
#define GMXLIBDIR "/data/pckr144/potestio/hadressmacs/hadress_spehere_static/share/gromacs/top"

/* Hardware and OS version for build host */
#define BUILD_MACHINE "Linux 3.4.28-2.20-desktop x86_64"

/* Date and time for build */
#define BUILD_TIME "Wed May  8 16:52:43 CEST 2013"

/* User doing build */
#define BUILD_USER "potestio@pckr144 [CMAKE]"
